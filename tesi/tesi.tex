...
sufficiente per Bologna. Nella campagna finale, su domanda uniforme low
l'attesa media è 406,64 secondi contro 198,65 di
\texttt{fixed\_program0}; in domanda uniforme medium è 781,01 contro 562,67. Il
...
concentra anche le partenze. L'80\% degli istanti deriva da due distribuzioni
beta, mentre il 20\% resta uniforme:
...
fairness o platoon; la sola burstiness non attiva Nmin e conduce alla modalità
\texttt{base}. Questa distinzione è importante: Nmin non dipende
...
\begin{figure}[htbp]
    ...
    \begin{axis}[
        ...
        xtick=data,
        x tick label style={rotate=45,anchor=east,font=\scriptsize},
        ylabel={Passi fuori da \texttt{program0} [\%]},
        ymin=0,
        ymax=6.2,
        bar width=12pt,
...
scenari dello stesso gruppo, ma conserva alcuni
